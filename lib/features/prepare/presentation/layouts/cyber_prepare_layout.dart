...
/// T5 Neo-Noir Cyber 테마용 Prepare 화면 레이아웃.
/// 블레이드러너 감성. 차가운 시안 그리드 위로 붉은 네온이 번져나가는 디지털 HUD.
class CyberPrepareLayout extends StatelessWidget {
  ...
  static const _ink = Color(0xFFE8E8F0);
  static const _inkDim = Color(0xFF9898A8);
  static const _inkFade = Color(0xFF5A5A68);
  static const _inkGhost = Color(0xFF3A3A48);
  static const _red = Color(0xFFFF1744);
  static const _redSub = Color(0xFF4DD0E1);
  static const _hair = Color(0x264DD0E1);
  static const _hairRed = Color(0x4DFF1744);
