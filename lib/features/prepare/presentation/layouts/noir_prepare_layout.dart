...
/// T2 Film Noir 테마용 Prepare 화면 레이아웃.
/// 1940s 탐정 영화 스타일. 크림 종이 위에 브래스 골드와 와인 블러드가 스며든다.
class NoirPrepareLayout extends StatelessWidget {
  ...
  // Film Noir 팔레트
  static const _bg = Color(0xFF0D0907);
  static const _bgPage = Color(0xFF050303);
  static const _ink = Color(0xFFE8DCC4);
  static const _inkDim = Color(0xFFA89A80);
  static const _inkFade = Color(0xFF6A5D48);
  static const _inkGhost = Color(0xFF3A2A1E);
  static const _red = Color(0xFFB89660);
  static const _redSub = Color(0xFF8B2635);
  static const _hair = Color(0x2EB89660);
  static const _hairRed = Color(0x72B89660);
